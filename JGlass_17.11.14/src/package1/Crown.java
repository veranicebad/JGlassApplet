 ...
 * @author Vera
 */
public class Crown extends MaterialObject {

    private URL filename = null;
    public BranchGroup branchGroup = null;

    public Crown(float mass, double x, double y, double z, int width, int height, Point3d gamma,
            boolean movable) {
        super(mass, x, y, z, width, height, gamma, movable);
        filename = JGlassApplet.class.getResource("crown.obj");
